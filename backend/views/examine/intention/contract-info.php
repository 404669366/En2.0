    ...
    <div class="ibox-content">
        <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" rows="10" name="remark"><?= $model->remark ?></textarea>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                <div class="col-sm-5 col-sm-offset-2">
                    <?php if ($model->status == 3): ?>
                        ...
                        <button type="submit" class="btn btn-info pass" data-st="4">通过</button>
                        &emsp;
                        <button type="submit" class="btn btn-info pass" data-st="2">驳回</button>
                        &emsp;
                    <?php endif; ?>
...
<script>
    $('.pass').click(function () {
        ...
        if ($(this).data('st') === 2 && !$('[name="remark"]').val()) {
            showMsg('请填写备注');
            return false;
        }
        return true;
