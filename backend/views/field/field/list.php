    ...
    <div class="ibox-content">
        <div class="dataTables_wrapper form-inline">
            <div class="row tableSearchBox">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-sm btn-info" href="/field/field/add">添加场地</a>
                </div>
            </div>
    ...
    myTable.load({
        ...
        columns: [
            ...
            },
            {
                ...
                if (row.status === '挂起' || row.status === '审核不通过') {
                    return '<a class="btn btn-sm btn-warning" href="/field/field/edit?id=' + data + '">编辑</a>';
                }
                return '<a class="btn btn-sm btn-info" href="/field/field/info?id=' + data + '">详情</a>';
            }
            }
        ],
