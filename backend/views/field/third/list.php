    ...
    <div class="ibox-content">
        <div class="dataTables_wrapper form-inline">
            <div class="row tableSearchBox">
                <div class="col-sm-11">
                    <span class="tableSpan">
                        综合搜索: <input class="searchField" type="text" value="" name="content"
                                     placeholder="编号/名称/标题/地址" style="width: 18rem">
                    </span>
                    <span class="tableSpan">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-sm btn-info" href="/field/third/edit">添加场地</a>
                </div>
            </div>
        ...
        columns: [
            ...
            },
            {
                ...
                if (row.status === '待处理' || row.status === '挂起' || row.status === '审核不通过') {
                    return str + '<a class="btn btn-sm btn-warning" href="/field/third/edit?id=' + data + '">编辑</a>';
                }
                return str + '<a class="btn btn-sm btn-info" href="/field/third/info?id=' + data + '">详情</a>';
            }
            }
        ],
        ...
        window.modal({
            ...
            callback: function (event) {
                ...
                if (input.data('fid') && input.val()) {
                    $.getJSON('/field/third/appoint', {id: input.data('fid'), tel: input.val()}, function (re) {
                        if (re.type) {
