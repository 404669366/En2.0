    ...
    <div class="ibox-content">
        <div class="dataTables_wrapper form-inline">
            <div class="row tableSearchBox">
                ...
                <div class="col-sm-1">
                    <a class="btn btn-sm btn-primary" href="/finance/income/cash-edit">申请提现</a>
                </div>
            </div>
    ...
    myTable.load({
        ...
        columns: [
            ...
            {"data": "created_at"},
            {
                ...
                return '<a class="btn btn-sm btn-info" href="/finance/income/cash-edit?no=' + data + '">详情</a>';
            }
            },
        ],
