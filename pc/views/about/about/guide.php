        ...
        <ul>
            ...
            <li class="nav active" onselectstart="return false">
                ...
                <ul>
                    ...
                    <li class="active"><a href="/about/about/guide.html">用户指南</a></li>
                </ul>
            </li>
...
<div class="center" style="background: #f2f4f6">
    <div class="guide">
        <ul class="fixed">
            <li class="title">用户指南</li>
            <li class="active" data-to="1">关于投资</li>
            <li data-to="2">关于收益</li>
            <li data-to="3">投资项目</li>
            <li data-to="4">法律协议</li>
        </ul>
        <div class="detail">
            <div>1111</div>
            <div>2222</div>
    ...
    <script>
        $('.fixed>:not(.title)').click(function () {
            $('.fixed>:not(.title)').removeClass('active');
            $(this).addClass('active');
            $('.detail>div').hide();
            var now = $(this).data('to');
            $('.detail>div:nth-child(' + now + ')').show();
        });
    </script>
</div>
<div class="footer">
